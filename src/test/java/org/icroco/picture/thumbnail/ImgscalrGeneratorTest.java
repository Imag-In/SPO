...
class ImgscalrGeneratorTest {
    ...
    void compute_thumbnail_size() {
        var generator = new ImgscalrGenerator(new DefaultMetadataExtractor(new KeywordManager(mock(KeywordRepository.class),
                                                                                              new KeywordMapperImpl(),
                                                                                              Collections.emptyMap()),
                                                                           mock(TaskService.class)));
        var thumbnail = generator.generate(Path.of("src/test/resources/images/benchmark/Corse 2015-20072015-036.jpg"),
                                           new Dimension(320, 302));
