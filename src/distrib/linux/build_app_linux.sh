...
if [ "${arch_name}" = "aarch64" ]; then
    ...
    sha256sum "${BUILD_DIR}/installer/${APP_NAME}_${APP_VERSION}_amd64.deb" > "${BUILD_DIR}/installer/${SPO_ARTIFACT_ID}_${APP_VERSION}_amd64.deb.sha256"
    mv "${BUILD_DIR}/installer/${SPO_ARTIFACT_ID}_${APP_VERSION}_amd64.deb" "${BUILD_DIR}/installer/${SPO_ARTIFACT_ID}_${APP_VERSION}_amd64.deb.sha256"
    sha256sum "${BUILD_DIR}/installer/${APP_NAME}-${APP_VERSION}-1.x86_64.rpm" > "${BUILD_DIR}/installer/${SPO_ARTIFACT_ID}-${APP_VERSION}-1.x86_64.rpm.sha256"
    mv "${BUILD_DIR}/installer/${SPO_ARTIFACT_ID}-${APP_VERSION}-1.x86_64.rpm" "${BUILD_DIR}/installer/${SPO_ARTIFACT_ID}-${APP_VERSION}-1.x86_64.rpm.sha256"
fi
