...
public final class NavTree extends TreeView<Nav> {
    ...
    public NavTree(RepairModel model) {
        super();
...
//            root.setMaxWidth(ApplicationWindow.SIDEBAR_WIDTH - 10);
        ...
        protected void updateItem(Nav nav, boolean empty) {
            ...
            if (nav == null || empty) {
                ...
                Nodes.toggleVisibility(arrowIcon, nav.isGroup());
                Nodes.toggleVisibility(tagLabel, nav.isTagged());
            }
        }
    }
    ...
    public static final class Item extends TreeItem<Nav> {
        ...
        public @Nullable RepairTool tool() {
            return nav.tool();
        }
        ...
        public static Item page(String title,
            ...
            return new Item(new Nav(title, null, tool, Collections.emptyList()));
        }
        ...
        public static Item page(String title,
            ...
            Objects.requireNonNull(tool, "tool");
            return new Item(new Nav(title, null, tool, List.of(searchKeywords)));
        }
    }
}
